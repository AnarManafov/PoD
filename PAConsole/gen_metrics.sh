...
java -jar ./PAConsole/trunk/PAConsole/sbin/statsvn.jar -css ./PAConsole/trunk/PAConsole/sbin/statsvn.css -output-dir ./PAConsole-metrics -tags '.*' svn.log ./PAConsole/


echo ">>> generating SLOC count report... <<<"
sloccount --crossdups  --wide ./PAConsole/trunk/PAConsole/ > result.txt
./PAConsole/trunk/PAConsole/sbin/sloc2html.py result.txt > ./PAConsole-metrics/result.html
