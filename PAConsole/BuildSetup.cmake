...
# Install directory
if ( NOT $ENV{PACONSOLE_LOCATION} STREQUAL "" )
set (CMAKE_INSTALL_PREFIX "$ENV{PACONSOLE_LOCATION}" CACHE PATH "Install path prefix, prepended onto install directories." FORCE)
endif ( NOT $ENV{PACONSOLE_LOCATION} STREQUAL "" )
