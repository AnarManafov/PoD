...

{
  ...
  // Files to analyze 
  set->Add( "http://www-linux.gsi.de/~manafov/D-Grid/Release/ROOT_DATA/dstarmb.root" );
  set->Add( "http://www-linux.gsi.de/~manafov/D-Grid/Release/ROOT_DATA/dstarmb2.root" );
