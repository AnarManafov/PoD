...
// Mon Nov 20 13:05:46 2006 by ROOT version 5.11/06
// from TTree h42/dstar
// found on file: /home/anar/PROOF_files/dstarmb.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Float_t         Q2eelec;
   Int_t           nelec;
   Float_t         Eelec[20];   //[nelec]
   Float_t         thetelec[20];   //[nelec]
   Float_t         phielec[20];   //[nelec]
   Float_t         xelec[20];   //[nelec]
   Float_t         Q2elec[20];   //[nelec]
   Float_t         xsigma[20];   //[nelec]
   Float_t         Q2sigma[20];   //[nelec]
   Float_t         sumc[4];
   Float_t         sumetc;
   Float_t         yjbc;
   Float_t         Q2jbc;
   ...
   Float_t         Mimpbk_r;
   Int_t           ntracks;
   Float_t         pt[200];   //[ntracks]
   Float_t         kappa[200];   //[ntracks]
   Float_t         phi[200];   //[ntracks]
   Float_t         theta[200];   //[ntracks]
   Float_t         dca[200];   //[ntracks]
   Float_t         z0[200];   //[ntracks]
   Float_t         covar[200][15];   //[ntracks]
   Int_t           nhitrp[200];   //[ntracks]
   Float_t         prbrp[200];   //[ntracks]
   Int_t           nhitz[200];   //[ntracks]
   Float_t         prbz[200];   //[ntracks]
   Float_t         rstart[200];   //[ntracks]
   Float_t         rend[200];   //[ntracks]
   Float_t         lhk[200];   //[ntracks]
   Float_t         lhpi[200];   //[ntracks]
   Float_t         nlhk[200];   //[ntracks]
   Float_t         nlhpi[200];   //[ntracks]
   Float_t         dca_d[200];   //[ntracks]
   Float_t         ddca_d[200];   //[ntracks]
   Float_t         dca_t[200];   //[ntracks]
   Float_t         ddca_t[200];   //[ntracks]
   Int_t           muqual[200];   //[ntracks]
   Int_t           imu;
   Int_t           imufe;
   Int_t           njets;
   Float_t         E_j[20];   //[njets]
   Float_t         pt_j[20];   //[njets]
   Float_t         theta_j[20];   //[njets]
   Float_t         eta_j[20];   //[njets]
   Float_t         phi_j[20];   //[njets]
   Float_t         m_j[20];   //[njets]
   Float_t         thrust;
   Float_t         pthrust[4];
   Float_t         thrust2;
   Float_t         pthrust2[4];
